	...
	<div class="modal-body">
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="consumerID" id="consumerID" class="form-control col-sm-8" placeholder="A###" />
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="consumerUsername" id="consumerUsername" class="form-control col-sm-8">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="consumerFullName" id="consumerFullName" class="form-control col-sm-8">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="consumerAddressStreet" id="consumerAddressStreet" class="form-control col-sm-8">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="consumerAddressSuite" id="consumerAddressSuite" class="form-control col-sm-8">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="consumerAddressCity" id="consumerAddressCity" class="form-control col-sm-8">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="consumerAddressState" id="consumerAddressState" class="form-control col-sm-8">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="consumerAddressZip" id="consumerAddressZip" class="form-control col-sm-8">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="consumerPhone" id="consumerPhone" class="form-control col-sm-8">
				</div>
			</div>
		</div>
