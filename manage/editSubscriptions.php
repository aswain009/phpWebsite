...
<!-- add <?=$plural; ?> table -->
<?php
$data = getSubscriptions('read', $_GET['subscriptionID']);
...
<form method="POST" action="view<?=$plural; ?>.php" id="<?=strtolower($singular); ?>Form">
	<div class="modal-body">
		<ul>
			...
			<li>Due to restrictions with Stripe; to edit a subscription plan interval, amount, and count you must delete the plan.</li>
			<li>Otherwise, you are able to edit the following fields below.</li>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="subscriptionName" id="subscriptionName" class="form-control col-sm-8" value="<?=$data->getName(); ?>">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="subscriptionStatement" id="subscriptionStatement" maxlength="22" class="form-control col-sm-8" value="<?=$data->getStatement(); ?>">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-12">
					<textarea name="subscriptionDescription" id="subscriptionDescription" class="form-control col-sm-12" rows="10"><?=$data->getDescription(); ?></textarea>
				</div>
			</div>
		</div>
