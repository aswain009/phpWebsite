							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin dataTable table-bordered">
									...
									<?php foreach ($data as $row) {
										//a3smedia\utilities\Database::pre_var_dump($row);
										$count = getConsumer('readByRetailer', $row->getID());
										$count = count($count);
										...
										echo '		<a href="editRetailers.php?'.strtolower($singular).'ID='.$row->getID().'" role="button" class="btn">Edit</a>';
