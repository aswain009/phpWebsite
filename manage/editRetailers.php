...
<!-- add <?=$plural; ?> table -->
<?php 
$data = getRetailer('readByID', $_GET['retailerID']);
?>
<form method="POST" action="view<?=$plural; ?>.php" id="<?=strtolower($singular); ?>Form" enctype="multipart/form-data">
	<div class="modal-body">
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<img src="<?=LOGO_URL.$data->getLogo(); ?>" alt="Preview Current Logo" title="Preview Current Logo" />
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="retailerID" id="retailerID" readonly="readonly" class="form-control col-sm-8" value="<?=$data->getID(); ?>" />
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="retailerName" id="retailerName" class="form-control col-sm-8" value="<?=$data->getName(); ?>" />
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="retailerEmail" id="retailerEmail" class="form-control col-sm-8" value="<?=$data->getEmail(); ?>" />
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" name="retailerMarkup" id="retailerMarkup" class="form-control col-sm-8" value="<?=$data->getMarkup(); ?>" />
				</div>
			</div>
		</div>
	...
	$(function(){
		...
		$('#retailerConsumerToo').on('change', function(){
			if($(this).is(':checked')){
				$('#consumerForm').show();
			} else {
				$('#consumerForm').hide();
